...
\ateneo{1ère Journée d'Économétrie Appliquée}
...
Si bruit important, on peut utiliser un lissage supplémentaire \[
(X_t - S_t) - I_t =TC_t
\]
...
\begin{frame}[fragile]{Introduction (4)}
...
\begin{center}\includegraphics[width=1\linewidth]{img/phase_shift_simul_norev} \end{center}
\end{frame}
