...
- Accessoirement : comment développer un environnement reproductible associé à la publication de son étude, créable en un clic à partir du [Datalab](https://datalab.sspcloud.fr/) ?\
...
::: {.incremental}
- [`renv`](https://rstudio.github.io/renv/) pour la gestion des dépendances sous R (voir [cours ENSAE sur la reproductibilité](https://ensae-reproductibilite.github.io/website/) pour Python)
