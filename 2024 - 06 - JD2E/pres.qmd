...
- Accessoirement : comment développer un environnement reproductible associé à la publication de son étude, créable en un clic ?
:::
...
::: {.incremental}
- [`renv`](https://rstudio.github.io/renv/) pour la gestion des dépendances (existe des équivalents sous Python, voir [cours ENSAE sur la reproductibilité](https://ensae-reproductibilite.github.io/website/))

- [Docker](https://hub.docker.com/) pour l'isolation des environnements

- GitHub pour l'initialisation des dépendances

- [Datalab](https://datalab.sspcloud.fr/) pour la création de l'environnement à partir de Docker
:::
...
- Repartir d'un projet existant et procéder par tâtonnement
