...
\tightlist
\item
  With the development of JDemetra+ 3.0, more than 12 \faIcon{r-project}
...
Utility functions used in \texttt{rjd3x13} and \texttt{rjd3tramoseats}
to set the specification of the preprocessing:
...
\hypertarget{rjd3x13}{%
\subsection{rjd3x13}\label{rjd3x13}}

\begin{frame}[fragile]{rjd3x13}
\protect\hypertarget{rjd3x13-1}{}
Main functions:
...
\hypertarget{rjd3highfreq}{%
\subsection{rjd3highfreq}\label{rjd3highfreq}}

\begin{frame}{rjd3highfreq}
\protect\hypertarget{rjd3highfreq-1}{}
