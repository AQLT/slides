...
\rel{}
\division{Division Études macroéconomiques}
...
Tendance-cycle publiée par peu d'instituts (\sout{Insee}, ONS,
Statistics Canada, ABS) mais volonté de faire des bonnes pratiques au
niveau européen (Destatis).
...
\begin{frame}{Illustration avec climats des affaires dans l'industrie
manufacturière}
\protect\hypertarget{illustration-avec-climats-des-affaires-dans-lindustrie-manufacturiuxe8re}{}
\begin{center}\includegraphics[width=1\linewidth]{img/climats_ex} \end{center}
\footnotesize
...
\item
  ...
  \url{https://github.com/palatej/rjdfilters}
\end{itemize}
\end{frame}
...
\texttt{rjdfilters::dfa\_filter()}}
\protect\hypertarget{approche-ats-rjdfiltersdfa_filter}{}
...
\item
  Garder les poids qui donnent des MM de meilleure qualité que les
  autres selon tous les critères ? Rien de satisfaisant
\item
  Faire quadrillage du plan et une analyse empirique du déphasage ?
  Difficile à analyser -\textgreater{} utiliser des méthodes de
...
\begin{center}\includegraphics[width=1\linewidth]{img/simul_phase_shift_norev} \end{center}
\end{frame}

\begin{frame}{Médiane des révisions (séries simulées)}
\protect\hypertarget{muxe9diane-des-ruxe9visions-suxe9ries-simuluxe9es}{}
Pour les séries à variabilité \textbf{moyenne} :
...
\begin{frame}{Médiane des révisions (séries simulées)}
\protect\hypertarget{muxe9diane-des-ruxe9visions-suxe9ries-simuluxe9es-1}{}
Pour les séries à variabilité \textbf{faible} :
...
\hspace{1em}QL (rel) & 1,7 & 1,1 & 1,2 & 1,1 & 1,0 & 0,9\\
\hspace{1em}\cellc{1}CQ (rel) & 2,1 & 1,7 & \cellc{1} 4,9 & 3,1 & 1,8 & 1,1\\
\hspace{1em}DAF (rel) & 2,2 & 2,0 & 5,8 & 3,6 & 2,0 & 1,3\\
\hspace{1em}\cellc{1}$b_{q,\Gamma}$ (rel) & 6,6 & 5,0 & 1,3 & 6,1 & \cellc{1}7,3 & \cellc{1}7,5\\
\hspace{1em}\cellc{1}$b_{q,G} (rel)$ & \cellc{1}8,8 & \cellc{1}8,9 & 1,1 & 6,2 & 7,3 & 7,5\\
\hspace{1em}\cellc{1}$b_{q,\varphi}$ (rel) & 2,6 & 1,9 & 1,3 & 1,7 & 3,3 & \cellc{1}9,8\\
...
\hspace{1em}\cellc{1}$b_{q,\Gamma}$ (rel) & 3,4 & 22,8 & 8,7 & 0,5\cellc{1} & \cellc{1}12,8 & \cellc{1}7,5\\
\hspace{1em}\cellc{1}$b_{q,G} (rel)$ & \cellc{1}13,7 & \cellc{1}10,2 & \cellc{1}11,6 & 0,8 & \cellc{1}9,1 & 7,5\\
\hspace{1em}\cellc{1}$b_{q,\varphi}$ (rel) & 1,5 & 3,0 & 2,3 & 2,8 & 1,7 & \cellc{1}9,8\\
...
\begin{frame}{Médiane des révisions (séries simulées)}
\protect\hypertarget{muxe9diane-des-ruxe9visions-suxe9ries-simuluxe9es-2}{}
Pour les séries à variabilité \textbf{forte} :
...
\hspace{1em}\cellc{1}CQ (rel) & 1,7 & 0,2 &\cellc{1} 19,1 & 9,2 & 1,4 & 2,1\\
\hspace{1em}\cellc{1}DAF (rel) & \cellc{1}11,0 & 1,4 & 4,2 & \cellc{1}9,3 & 1,6 & 2,3\\
\hspace{1em}$b_{q,\Gamma}$ (rel) & 1,0 & 1,3 & 1,3 & 0,2 & 0,9 & 1,4\\
\hspace{1em}$b_{q,G} (rel)$ & 0,9 & 1,5 & 8,5 & 0,2 & 0,8 & 1,4\\
\hspace{1em}\cellc{1}$b_{q,\varphi}$ (rel) & 1,2 & 1,6 & 3,3 & 4,3 & 1,0 & \cellc{1}10,7\\
\hspace{1em}\cellc{1}ARIMA (rel) & \cellc{1}32,8 & 1,4 & 0,8 & 1,6 & 0,9 & 0,9\\
\bottomrule
\end{tabular}
\end{table}
\end{frame}
...
\begin{frame}{Retour sur les climats des affaires dans l'industrie}
\protect\hypertarget{retour-sur-les-climats-des-affaires-dans-lindustrie}{}
\begin{center}\includegraphics[width=1\linewidth]{img/climats_prev_impl} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{img/simul_phase_shift_localic_norev} \end{center}
\end{frame}
...
\begin{center}\includegraphics[width=1\linewidth]{img/nber/retailx_localic} \end{center}
\end{frame}

\begin{frame}{Résultats (3)}
\protect\hypertarget{ruxe9sultats-3}{}
\begin{center}\includegraphics[width=1\linewidth]{img/nber/retailx_localic_implicit_forecast} \end{center}
\end{frame}
