---
title: "Performance of asymmetric filters for trend-cycle estimation during the COVID-19 crisis"
author: ""
output:
...
lang: "english"
fontsize: 12pt
keywords: [trend estimation, seasonal adjustment, Henderson filter, asymmetric filters, R]
...
The **Henderson filter** is a filter widely: it's for example the filter used in the seasonal adjustment algorithm X-12ARIMA. 
...
- The one developed by @proietti2008 that consists in locally approximated the trend by a polynomial trend. In this paper, three asymmetric filters are considered:
...
The figure \@ref(fig:cl2all) compares the different asymmetric filters applying them to the seasonally adjusted series of French industrial production index of the manufacturing industry^[This series is produced by the INSEE, the French National Statistical Office, and is available at https://bdm.insee.fr/series/sdmx/data/SERIES_BDM/010537946.]. 
