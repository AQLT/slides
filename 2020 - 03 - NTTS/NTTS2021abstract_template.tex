...
%% the conference (https://www.conference-service.com/NTTS2021/documents/NTTS2021_Abstract_template.dot)
%% Prepared by J.Grazzini (Eurostat, unit B1)
%% Revised on 08/20

\def\thisfile{NTTS2021abstract_template}

%% WHO ARE YOU: LIST THE AUTHORS HERE
\def\theauthors{
%\textsc{\color{red}{\parbox{0.9\textwidth}{ % delete this line when submitting
...
\EndIf
\BState \emph{hell} 
\State \text{Try again at NTTS 2023!}
\BState \emph{Bruxelles (some people also call it hell)}:
\State \text{See you at NTTS 2021!}
\EndProcedure
\end{algorithmic}
\end{algorithm}
\end{small}
