...
\hypertarget{how-to-use-rjdemetra-to-improve-production-of-sa-series}{%
\section{How to use RJDemetra to improve production of SA
series?}\label{how-to-use-rjdemetra-to-improve-production-of-sa-series}}
...
\tightlist
\item
  persephone (experimental): enable easy processing during production of
  SA series (interactive plots, dashboards\ldots{})
\end{itemize}
...
\includegraphics{img/markdown-unnamed-chunk-18-1.pdf}
