...
Passionné de R, développe et maintien plusieurs packages autour de la désaisonnalisation
...
- Un package `rjd3filters` pour créer et manipuler les moyennes mobiles, un projet de soumission au Journal of Statistical Software
...
\hspace{1em}CQ (rel) & 2,1 & 1,7 & 4,9 & 3,1 & 1,8 & 1,1\\
...
\hspace{1em}\cellc{1}$b_{q,G} (rel)$ & 13,7 & \cellc{1}10,2 & \cellc{1}11,6 & 0,8 & \cellc{1}9,1 & 7,5\\
