...
\begin{frame}[fragile]{Évaluer la qualité des estimations avec prév.
implicites}
\protect\hypertarget{uxe9valuer-la-qualituxe9-des-estimations-avec-pruxe9v.-implicites}{}
...
\begin{frame}{Illustration FST}
\protect\hypertarget{illustration-fst}{}
...
\begin{center}\includegraphics[width=1\linewidth]{img/mm_penteconcavite} \end{center}
...
\begin{frame}{Autour de la détection en temps réel des points atypiques
?}
\protect\hypertarget{autour-de-la-duxe9tection-en-temps-ruxe9el-des-points-atypiques}{}
Buono et al(2016), Detecting outliers at the end of the series using
forecast intervals

Même idée que TERROR (CAPORELLO et MARAVALL 2004) mais en plus une
caractérisation des points atypiques (AO, LS, TC)

\pause

Rester autour de l'estimation de la tendance-cycle (reproduire en
utiliser les estimations des IC et prévisions implicites) ou être sur
...
\begin{itemize}
\item
  Étude des modèles de régression linéaire avec des coefficients qui
  varient dans le temps (notamment modèles espace-état)\\
  \faArrowCircleRight{} Repartir de là pour étude sur les points
  atypiques ? (ex : test sur la variance des coefficients)
\item
  {[}Non débuté{]} : Étude de construction de climats des affaires
  ``prédictifs'' (plutôt qu'analyse factorielle) ?
\end{itemize}
\end{frame}
